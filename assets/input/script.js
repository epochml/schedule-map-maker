...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function arrowFetch() {
        ...
        try {
                ...
                if (json.status == 1) {
                    document.getElementById('error_message').innerHTML = `There was an error: ${json.error_message}. Hint: checking the <a id="error_message_link" href="https://epochml.github.io/schedule-map-maker/about/">About Page</a> might help you`;
                    return;
                }
            ...
            document.getElementById('error_message').innerHTML = `There was an error: ${err.message}. Hint: checking the <a id="error_message_link" href="https://epochml.github.io/schedule-map-maker/about/">About Page</a> might help you`;
        }
